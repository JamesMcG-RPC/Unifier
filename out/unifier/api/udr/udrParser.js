 ...
 *
 */
export function udrParser(udr) {
    const headers = udr.report_header;
    const rows = udr.report_row;
    const converted = rows.map((row, _i) => R.reduce((acc, [key, value]) => ({
        ...acc,
        [headers[key]["name"]]: parseValue(headers[key]["type"], value)
...
//# sourceMappingURL=udrParser.js.map