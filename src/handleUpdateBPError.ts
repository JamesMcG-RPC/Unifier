...
export async function handleUpdateBPError(
    logger: Logger,
    unifier: AxiosInstance,
    event: EventNotification,
    update: UnifierBPResponse
) {
    ...
    const updateToErrorStep: UnifierBPResponse = await unifier.put(
        `/ws/rest/service/v2/bp/record`,
        bp
    );
